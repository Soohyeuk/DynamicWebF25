...
const Modal = (props) => {
  ...
  // class name manipulation using useEffect
  useEffect(() => {
  ...
  return ReactDOM.createPortal(
    <>
      {/*overlay; covers the entire screen; onClick closes the modal */}
      <div onClick={onClose} className={overlayClass}></div>
      {/*modal window; displays the modal content and some sort of close button */}
