// the most basic way to deal with state using useState()
// the problem with useState() is that if we want to update in multiple ways, we'd 
// have to use multiple set functions where each does all the calculation
...
const CounterPage = ({initialCount}) => {
  ...
  const handleSubmit = (event) => {
    ...
    // use adds input number to count
